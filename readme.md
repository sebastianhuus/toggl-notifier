...
1. User schedules workday with particular color in Google Calendar
2. When `/api/check` endpoint hit, calculate sum difference between total time logged in a particular Toggl Track project today vs total time planned for the configured calendar event color `CALENDAR_COLOR_ID` today. 
